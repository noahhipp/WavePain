...
% Housekeeping
eda_name_in     = 'all_eda_behav.csv'; % This gets overwritten at the end
eda_name_out    = 'all_eda_behav_old_variable_names.csv'; % We use this to backup the old data
...
% Archive orignal data
writetable(original_data, eda_file_out);
...
data.time_within_trial  = repmat(linspace(0,110,subject.minSclLength),1,...
    n_trials)';
data.zdt_scl            = original_data.scl;
