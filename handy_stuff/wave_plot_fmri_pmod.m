...
elseif numel(data{1}.contrast) == 26 % pmodV6
    ana_type = 4;
elseif numel(data{1}.contrast) == 15 % pmodV7
    ana_type = 5;
end
...
elseif ana_type == 5
    pmod_names          = {'wm_heat', 'wm_wm', 'wm_diffheat',...
        'wm_heat_X_wm', 'wm_heat_X_diffheat', 'wm_wm_X_diffheat',...
        'wm_heat_X_wm_X_diffheat',...
        'wm_leads', 'wm_ramp_up', 'wm_ramp_down',...
