...
load E:\wavepain\data\fmri_sample\fmri\second_Level\second_level_anovacanonical_pmodV7\pmod_struct.mat

HOST            = wave_ghost2('fmri'); %wave_gethost
FIG_DIR         = fullfile(HOST.results,...
    '2023', '10_canonical_pmodV7');
...
% Obtain names
wm_names = pmod_struct.names(1:10);
online_names = pmod_struct.names(11:15);
...
for i = 1:numel(subs)
    ...
    for j = 1:2 % sessions
        ...
        online = array2table(sub_data.online{j}(:,[2 4 6 10 11]), 'VariableNames', online_names);
