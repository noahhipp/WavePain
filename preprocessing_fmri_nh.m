...
for g = 1:size(all_subs,2) 
        ...
        if do_4d
            for l=1:size(epi_folders,2)
                ...
                fourd_batch{fourd_i}.cfg_basicio.file_dir.file_ops.file_move.files = cellstr(epi_files{l});
                fourd_batch{fourd_i}.cfg_basicio.file_dir.file_ops.file_move.action.delete = false;
                fourd_i = fourd_i + 1;
            end
